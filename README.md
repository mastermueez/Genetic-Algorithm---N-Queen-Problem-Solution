## Description
The n queen problem requires one to find possible arrangements of n queens on an n x n chessboard such that no queens are in attacking pairs. The code here finds such an arrangement when executed. This [video](https://www.youtube.com/watch?v=qt85_CinKwo) explains the problem well.
